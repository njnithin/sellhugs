    ...
    <v-row justify="center">
      ...
      <v-flex v-else>
        ...
        <v-card class="pa-4 my-10">
          ...
          <v-card width="100%" :key="'header-'+index" v-for="(eachData,key,index) in serverResponse.headers" class="pa-3 mb-1">
        ...
        <v-card class="pa-4 my-10">
          ...
          <v-card width="100%" :key="'config-'+index" v-for="(eachData,key,index) in serverResponse.config" class="pa-3 mb-1">
